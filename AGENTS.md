...
- Test fixtures live in `Tests/PureFITTests/Fixtures`, named `<writer>-<sport>-<what it covers>.fit`. Their README explains what each covers; add a row when you add a fixture.
