...
- Benchmark CI gates on the PureFIT/Garmin *ratio* in `Benchmarks/ratio-budget.json`, not absolute times. Only raise a budget for a deliberate trade-off, and say so in the PR.
