...
public struct MassField: NamedFieldDefinition, DimensionalFieldDefinition, MeasurableFieldDefinition {
    public struct Value: FieldValue, MeasurementValue {
        public let measurement: Measurement<UnitMass>
    }

    public let name: String
    public let baseType: FITBaseType
    public let unit: UnitMass
